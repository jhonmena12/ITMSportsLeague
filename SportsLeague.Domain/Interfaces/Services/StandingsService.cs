...
namespace SportsLeague.Domain.Interfaces.Services
{
...

    {
...

        {
            ...
            // de la lista de resultado, donde la clave es el matchid  y el valor es el MatchResult completo.
            // Esto me permite acceder rápidamente al resultado de un partido dado su ID sin tener que recorrer toda la lista cada vez. Es una optimización para mejorar el rendimiento al calcular las estadísticas de los equipos.
